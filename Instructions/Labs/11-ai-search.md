---
lab:
  title: استكشاف فهرس Azure الذكاء الاصطناعي Search (UI)
---

# استكشاف فهرس Azure الذكاء الاصطناعي Search (UI)

لنتخيل أنك تعمل في Fourth Coffee، وهي سلسلة مقاهي وطنية. يُطلب منك المساعدة في بناء حل للتنقيب عن المعرفة يجعل من السهل البحث عن رؤى حول تجارب العملاء. قررت إنشاء فهرس Azure الذكاء الاصطناعي Search باستخدام البيانات المستخرجة من مراجعات العملاء.  
...
- **مورد Azure الذكاء الاصطناعي Search**، والذي سيدير الفهرسة والاستعلام.
- مورد **خدمات الذكاء الاصطناعي في Azure**، والذي يوفر خدمات الذكاء الاصطناعي للمهارات التي يمكن أن يستخدمها حل البحث الخاص بك لإثراء البيانات في مصدر البيانات بالرؤى الناتجة عن الذكاء الاصطناعي.
    ...
    > **ملاحظة** يجب أن تكون موارد خدمات Azure الذكاء الاصطناعي وAzure الذكاء الاصطناعي في نفس الموقع!
...
1. **انقر فوق الزر + Create a resource**، وابحث عن *Azure الذكاء الاصطناعي Search*، وأنشئ **مورد Azure الذكاء الاصطناعي Search** بالإعدادات التالية:

    - **الاشتراك**: *اشتراك Azure الخاص بك*.
    - **مجموعة الموارد**: *أنشئ مجموعة موارد جديدة ذات اسم فريد*.
    - **Service name**: *اسم فريد*.
    - **الموقع**: *اختر أي منطقة متوفرة. إذا كان في شرق الولايات المتحدة، فاستخدم "شرق الولايات المتحدة 2".*
    - **مستوى التسعير**: أساسي

1. حدد **معاينة + إنشاء**، وبعد أن تظهر لك استجابة **نجاح التحقق**، حدد **إنشاء**.

1. بعد اكتمال التوزيع، حدد «**Go to resource**». في صفحة نظرة عامة على Azure الذكاء الاصطناعي Search، يمكنك إضافة فهارس واستيراد البيانات والبحث في الفهارس التي تم إنشاؤها.

### إنشاء مورد خدمات الذكاء الاصطناعي في Azure

ستحتاج إلى توفير **مورد خدمات** Azure الذكاء الاصطناعي في نفس موقع مورد Azure الذكاء الاصطناعي Search. سيستخدم حل البحث الخاص بك هذا المورد لإثراء البيانات الموجودة في مخزن البيانات بالرؤى التي تم إنشاؤها بواسطة الذكاء الاصطناعي.
...
1. قم بالرجوع إلى الصفحة الرئيسية في مدخل Azure. انقر فوق زر **＋أنشئ مورد** وابحث عن *خدمات ذكاء اصطناعي في Azure*. حدد **إنشاء** **خطة خدمات الذكاء الاصطناعي في Azure**. سيتم نقلك إلى صفحة لإنشاء مورد خدمات ذكاء اصطناعي في Azure. قم بتكوينه بالإعدادات التالية:
    - **الاشتراك**: *اشتراك Azure الخاص بك*.
    - **مجموعة** الموارد: *نفس مجموعة الموارد مثل مورد* Azure الذكاء الاصطناعي Search.
    - **المنطقة**: *نفس موقع مورد* Azure الذكاء الاصطناعي Search.
    - **Name**: *اسم فريد*.
...
1. ابحث عن *storage account*، وأنشئ مورد **storage account** باستخدام الإعدادات التالية:
    - **الاشتراك**: *اشتراك Azure الخاص بك*.
    - **مجموعة** الموارد: *نفس مجموعة الموارد مثل Azure* الذكاء الاصطناعي Search وموارد خدمات Azure الذكاء الاصطناعي.
...
1. في علامة تبويب متصفح جديدة، قم بتنزيل [مراجعات القهوة المضغوطة](https://aka.ms/mslearn-coffee-reviews) من `https://aka.ms/mslearn-coffee-reviews`، واستخرج الملفات إلى *مجلد المراجعات* .
...
بعد أن يكون لديك المستندات في التخزين، يمكنك استخدام Azure الذكاء الاصطناعي Search لاستخراج الرؤى من المستندات. يوفر Azure-Portal *Import data wizard*. باستخدام هذا المعالج، يمكنك تلقائيا إنشاء فهرس ومفهرس لمصادر البيانات المدعومة. ستستخدم المعالج لإنشاء فهرس، واستيراد مستندات البحث من التخزين إلى فهرس Azure الذكاء الاصطناعي Search.

1. في مدخل Microsoft Azure، استعرض للوصول إلى مورد Azure الذكاء الاصطناعي Search. ثم، في صفحة **Overview** حدد **Import data**.
...
1. ارجع إلى صفحة مورد Azure الذكاء الاصطناعي Search. في الجزء الأيمن، ضمن **إدارة** البحث، حدد  **المفهرسات**. حدد مفهرس** القهوة الذي تم إنشاؤه **حديثا. انتظر دقيقة، ثم حدد **&orarr; Refresh** حتى تشير **Status** إلى النجاح.
...
2. لاحظ كيف أن الفهرس المحدد هو *coffee-index* الذي أنشأته. أسفل الفهرس المحدد، قم بتغيير *طريقة العرض إلى **طريقة عرض*** JSON. 

    ![لقطة شاشة لمتصفح البحث.](media/create-cognitive-search-solution/search-explorer-query.png)

في **حقل محرر** استعلام JSON، انسخ والصق: 
```json
{
    "search": "*",
    "count": true
...
```
3. حدد **بحث**. يعرض استعلام البحث جميع المستندات الموجودة في فهرس البحث، بما في ذلك عدد جميع المستندات في الحقل **@odata.count**. يجب أن يُرجع فهرس البحث مستند JSON مدرجًا فيه نتائج البحث.

4. الآن دعونا نباشر بتصفية حسب الموقع. في **حقل محرر** استعلام JSON، انسخ والصق: 
```json
{
...
```
5. حدد **بحث**. يبحث الاستعلام في جميع المستندات الموجودة في الفهرس وعوامل التصفية لمراجعات ذات موقع في شيكاغو. يجب أن تشاهد `3` في `@odata.count` الحقل.

6. الآن دعونا نصفي حسب التوجه. في **حقل محرر** استعلام JSON، انسخ والصق: 
```json
{
...
```
7. حدد **بحث**. يبحث الاستعلام في جميع المستندات الموجودة في الفهرس وعوامل التصفية لمراجعات ذات توجه سلبي. يجب أن تشاهد `1` في `@odata.count` الحقل.
...
8. إحدى المشكلات التي قد نرغب في حلها هي سبب وجود مراجعات معينة. دعنا نلقِ نظرة على العبارات الرئيسية المرتبطة بالمراجعة السلبية. ما هو برأيك سبب المراجعة؟
...
4. انقر فوق **Edit** لرؤية JSON الذي تم إنتاجه لأحد المستندات من مخزن بيانات Azure.

    ![لقطة شاشة لكيفية العثور على زر التحرير.](media/create-cognitive-search-solution/knowledge-store-blob-2.png)

5. حدد عنوان storage blob في أعلى يسار الشاشة للعودة إلى *Containers* لـ Storage account.
...
6. في *Containers*، حدد الحاوية *coffee-skillset-image-projection*. حدد أي من العناصر.

    ![لقطة شاشة لحاوية مجموعة المهارات.](media/create-cognitive-search-solution/knowledge-store-blob-5.png)

7. حدد أي من ملفات *.jpg*. انقر فوق **Edit** لمشاهدة الصورة المخزنة من المستند. لاحظ كيف يتم تخزين جميع الصور من المستندات بهذه الطريقة.

    ![لقطة شاشة للصورة المحفوظة.](media/create-cognitive-search-solution/knowledge-store-blob-3.png)

8. حدد عنوان storage blob في أعلى يسار الشاشة للعودة إلى *Containers* لـ Storage account.

9. حدد **Storage browser** على اللوحة اليسرى، وحدد **Tables**. يوجد جدول لكل كيان في الفهرس. حدد الجدول *coffeeSkillsetKeyPhrases*.
...
فهرس البحث البسيط هذا فقط بعض قدرات Azure الذكاء الاصطناعي خدمة البحث. لمعرفة المزيد حول ما يمكنك القيام به مع هذه الخدمة، راجع [صفحة](https://learn.microsoft.com/azure/search) الذكاء الاصطناعي خدمة البحث Azure.
