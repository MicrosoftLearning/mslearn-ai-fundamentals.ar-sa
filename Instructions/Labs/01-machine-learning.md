...
>**مهم** في هذا الوقت، من الممكن تأليف نموذج ونشره كخدمة ويب في Azure Machine Learning Studio، ولكن ليس من الممكن اختباره في Studio. ومن ثمَّ، من الممكن إكمال كل الخطوات، باستثناء الجزء الأخير منها قبل عملية التنظيف. سنُطبِّق تحديثات عند حدوث أي تغييرات.
   ...
   **نوع المهمة والبيانات**:
    ...
    **إعدادات المهمة**:
    ...
    - **** الحدود: *توسيع هذا القسم*
        ...
        - **الحد الأقصى للعقد**: 3
        - **حد درجة القياس**: 0.085 (*وبالتالي إذا حقق النموذج درجة مقياس خطأ متوسط ​​الجذر التربيعي الطبيعي 0.085 أو أقل، تنتهي المهمة.*)
        - **المهلة**: 15
        - **مهلة التكرار**: 15
...
>**مهم** لا يدعم Azure Machine Learning Studio حاليًا نوع إنشاء مجموعة البيانات اللازمة لاستخدام اختبار التوزيع. سنُحدِّث عند وجود حل. 
