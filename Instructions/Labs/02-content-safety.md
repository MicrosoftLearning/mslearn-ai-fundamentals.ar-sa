...
>**ملاحظة**: إذا كنت تستخدم اشتراك Cloud Slice، يمكنك تخطي الخطوات من #7 إلى 12 والانتقال إلى الخطوة #13. بخلاف ذلك، تابع الخطوة #7.

7. حدد **عرض كل الخصائص في مدخل Azure** أسفل شاشة *الإعدادات*. 

![لقطة شاشة لارتباط عرض كل الخصائص في مدخل Azure.](./media/content-safety/view-all-properties.png)

8. في مدخل Azure، حدد مورد *Content Safety* الذي قمت بإنشائه للتو. بعد ذلك، حدد على الجزء الأيمن **التحكم بالوصول (IAM)** بعد ذلك، على الجزء المفتوح، حدد **إضافة** بجانب عامل الإضافة وحدد **إضافة تعيين دور**. 

![لقطة شاشة لمكان تحديد إضافة تعيين دور في جزء التحكم بالوصول.](./media/content-safety/access-control-step-one.png)

9. ابحث عن **مستخدم الخدمات المعرفية** في قائمة الأدوار، وحدده. بعد ذلك حدد **التالي**. 

10. استخدم الإعدادات التالية لتعيين الدور لنفسك: 
    - **تعيين الوصول إلى**: حدد *المستخدم أو المجموعة أو كيان الخدمة*
    - **الأعضاء**: انقر فوق *تحديد الأعضاء*
        - في جزء *تحديد الأعضاء* المفتوح، ابحث عن اسمك. انقر فوق أيقونة عامل الإضافة بجانب اسمك. ثم انقر فوق "**Select**".
    - **الوصف**: *اتركه فارغاً*

11. حدد **مراجعة وتعيين**ثم حدد **مراجعة وتعيين** مجدداً لإضافة تعيين الدور.    

12. ارجع إلى Content Safety Studio على [https://contentsafety.cognitive.azure.com](https://contentsafety.cognitive.azure.com). بعد ذلك، حدد أيقونة **الإعدادات** أعلى الجانب الأيسر من الشاشة. 

![لقطة شاشة لأيقومة الإعدادات في الجزء العلوي الأيمن من الشاشة، بجوار أيقونات الجرس وعلامة الاستفهام والابتسامة.](./media/content-safety/settings-toggle.png)
 
13. حدد مورد خدمة الذكاء الاصطناعي في Azure الذي قمت بإنشائه للتو. تأكد من أنك ترى كل من *مستخدم الخدمات المعرفية* و*المالك* ضمن *تعيينات الأدوار الحالية*.

![لقطة شاشة لتعيينات الأدوار الحالية.](./media/content-safety/access-control-check-step.png)

14. انقر فوق **استخدام المورد** أسفل الشاشة. سيتم نقلك مرة أخرى إلى الصفحة الرئيسية للاستوديو. الآن يمكنك البدء في استخدام الاستوديو مع المورد الذي تم إنشاؤه حديثًا.
