---
lab:
  title: استكشاف التعلم الآلي التلقائي في Azure التعلم الآلي
---

# استكشاف التعلم الآلي التلقائي في Azure التعلم الآلي
...
1. إنشاء مهمة تعلّم آلي تلقائية جديدة باستخدام الإعدادات التالية، باستخدام **التالي** كما هو مطلوب للتقدم من خلال واجهة المستخدم:
   ...
   **نوع المهمة والبيانات**:
    ...
    - **حدد مجموعة البيانات**: إنشاء مجموعة بيانات جديدة بالإعدادات التالية:
        ...
        حدد **إنشاء**. بعد إنشاء مجموعة البيانات، حدد **مجموعة بيانات تأجير الدراجات** لمتابعة إرسال مهمة التعلم الآلي التلقائي.
    ...
    **إعدادات المهمة**:
    ...
    - **** الحدود: *توسيع هذا القسم*
        ...
        - **الحد الأقصى للعقد**: 3
        - **عتبة** درجة المقياس: 0.085 (*بحيث إذا حقق النموذج درجة مقياس خطأ تربيعية متوسطة للجذر تمت تسويتها تبلغ 0.085 أو أقل، تنتهي المهمة.*)
        - **المهلة**: 15
        - **مهلة** التكرار: 15
    ...
    **الحساب**:
    ...
    \**إذا كان اشتراكك يقيد أحجام الأجهزة الظاهرية المتوفرة لك، فاختر أي حجم متوفر.*
