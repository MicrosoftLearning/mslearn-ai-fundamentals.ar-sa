...
1. راجع الاستجابة وتابع الأسئلة الإضافية حسب الحاجة. عندما تكون راضيًا عن الاستجابة، استخدم **أيقونة نسخ** (#128461;) ضمن الاستجابة لنسخها إلى الحافظة. ألصق هذا في مستند Word، وحدد النص بالكامل ثم حدد أيقونة Copilot (أسفل النص المحدد) لتمثيل النص كجدول.
...
1. إذا لم يتم تنسيق التوقعات المالية في خطة العمل كجدول، فحددها واستخدم Copilot لتمثيل التوقعات كجدول.
1. حدد جدول التوقعات المالية وانسخه إلى الحافظة.
1. احفظ مستند Word ثم أغلقه.
...
1. افتح **Excel** وقم بإنشاء مصنف فارغ جديد. احفظ المصنف فوراً باسم **Financial Projections.xlsx** في OneDrive، وإلا لن يعمل Copilot.
...
1. باستخدام توقعات مبيعاتك المنسقة كجدول، افتح جزء Copilot من علامة تبويب **الشريط الرئيسي** لشريط Excel وأدخل المطالبة التالية:

    ```
    Suggest ways to visualize these financial projections.
    ```
    
1. من المفترض أن يقترح Copilot طريقة لتمثيل بياناتك باستخدام مخططات ويعرض إضافة مخطط محوري إلى ورقة جديدة.
...
1. افتح **Outlook**. إذا لم تقم بإعداد Outlook باستخدام حساب Microsoft 365 الخاص بك، فقم بذلك.

    > **تلميح**: استعرض [إعداد Outlook واستخدامه - دعم Microsoft](https://support.microsoft.com/office/set-up-and-use-outlook-4636f361-d5e3-4a87-9cd4-382858de55fa) للحصول على تعليمات بخصوص هذا.

1. على شريط الأدوات، قم بالتبديل إلى تجربة **Outlook** الجديدة إذا لم تكن نشطة بالفعل.

    > **ملاحظة**: للحصول على أحدث ميزات Copilot في Outlook، يجب أن تستخدم تجربة جديدة لـ "Outlook". لمعرفة الإصدار الذي تستخدمه، راجع [ما هو إصدار Outlook المتوفر لدي؟ - دعم](https://support.microsoft.com/office/what-version-of-outlook-do-i-have-b3a9568c-edb5-42b9-9825-d48d82b2257c) Microsoft.
...
1. أدخل المطالبة التالية واضبط الخيارات لتعيين الأسلوب إلى "رسمي" والطول إلى "متوسط":
...
1. حدد الشريحة الأخيرة الثانية في العرض التقديمي. بعد ذلك، في جزء Copilot، استخدم المطالبة **أضف شريحة حول...** لإنشاء شريحة جديدة حول `the benefits of an eco-friendly approach to cleaning.`
