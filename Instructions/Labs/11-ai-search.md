...
1. في النصف السفلي من **صفحة نظرة عامة** لمورد Azure الذكاء الاصطناعي Search، حدد **علامة التبويب Indexers**. تعرض علامة التبويب هذه مفهرس** القهوة الذي تم إنشاؤه **حديثا. انتظر دقيقة، ثم حدد **&orarr; Refresh** حتى تشير **Status** إلى النجاح.
...
فهرس البحث البسيط هذا فقط بعض قدرات Azure الذكاء الاصطناعي خدمة البحث. لمعرفة المزيد حول ما يمكنك القيام به مع هذه الخدمة، راجع [صفحة](/azure/search/search-what-is-azure-search) الذكاء الاصطناعي خدمة البحث Azure.
